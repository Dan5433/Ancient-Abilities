...
execute if score $timer_minutes ancient_abilities.temp matches 0 run return run title @s actionbar [{text:"On Cooldown: ",color:red},{score:{name:"@s",objective:"ancient_abilities.ability_right_click_cooldown"}},{text:"s"}]
