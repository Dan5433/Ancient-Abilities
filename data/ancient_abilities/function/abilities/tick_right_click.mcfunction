...
execute as @s[team=ancient_abilities.abilities.legendary.enchanter] unless predicate ancient_abilities:can_enchant_mainhand run return run execute unless score @s ancient_abilities.crouched matches 1.. run title @s actionbar {text:"Cannot enchant item",color:red}
