execute on attacker if score @s ancient_abilities.null_posion matches 1.. run return run title @s actionbar [{text:"Nullified: ",color:red},{score:{name:'@s',objective:ancient_abilities.null_posion}},"s"]
